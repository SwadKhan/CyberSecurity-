...
4. Implement Harmony Search variants (continuous, binary, and multi-objective if needed).
5. Compare HS with GA, PSO and baseline heuristics on detection performance, cost, and resilience.
6. Evaluate under multiple attack scenarios and quantify robustness.
