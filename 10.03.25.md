...
3. Address Resolution Protocol (ARP) is used to determine the device MAC address of a known destination device IPv4 address. Neighbour Discovery (ND) is used to determine the MAC address of a known destination device IPv6 address.

9.3.5 Check Your Understanding - Neighbour Discovery
